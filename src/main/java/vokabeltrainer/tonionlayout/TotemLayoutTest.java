...
/**
 * <code>TotemLayoutTest</code> is part of TOnionLayout. It is used instead of
 * <code>TotemLayout</code> in order to find inconsistencies in sizes.
 * 
 * @author Birke Heeren
 * @since private
...
public class TotemLayoutTest extends TotemLayout
{
   ...
   public TotemLayoutTest(Container self, String name)
   {
      super(self);
      callOnce = true;
      this.name = name;
   ...
   public TotemLayoutTest(Container self, int vgap, String name)
   {
      super(self, vgap);
      callOnce = true;
      this.name = name;
