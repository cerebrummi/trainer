...
/**
 * <code>TrainLayoutTest</code> is part of TOnionLayout. It is used instead of
 * <code>TrainLayout</code> in order to find inconsistencies in sizes.
 * 
 * @author Birke Heeren
 * @since private
...
public class TrainLayoutTest extends TrainLayout
{
   ...
   public TrainLayoutTest(Container self, String name)
   {
      super(self);
      callOnce = true;
      this.name = name;
   ...
   public TrainLayoutTest(Container self, int hgap, String name)
   {
      super(self, hgap);
      callOnce = true;
      this.name = name;
   ...
   public void layoutContainer(Container self)
   {
      synchronized (self.getTreeLock())
      {
         ...
         System.out.println(name + ": width available to layout is " + w);
         System.out.println(name + ": height available to layout is " + h);
         int hmin = 0;
