...
public class LetterFeedbackImage
{
   ...
   public static BufferedImage makeTest(HebrewLetter letterDic, HebrewLetter letterAnswer, boolean okay)
   {
      int delta = 23;
...
//         path.moveTo(midX, 0D+delta);
//         path.lineTo(midX, 24D+delta);
//         path.lineTo(midX - 4D, 16D+delta);
//         g2d.draw(path);
