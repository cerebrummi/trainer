...
public abstract class Common {
    ...
    public static void setUI() {
        try {
            ...
            nimbus.getDefaults().put("internationalFont", new Font(Font.SANS_SERIF, Font.PLAIN, 16));
            ApplicationFonts.internationalFont = nimbus.getDefaults().getFont("internationalFont");
            ...
            UIManager.put("FileChooser.saveButtonToolTipText", translator.realisticTranslate(Translation.AUSGEWAEHLTE_DATEI_SPEICHERN));
