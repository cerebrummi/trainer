...
public class InformationTab extends JPanel
{
   ...
   public InformationTab()
   {
      ...
      leftSide.setBackground(Settings.getDarkGold());
      
      JPanel fillerTop = new JPanel(new FlowLayout());
      fillerTop.setMinimumSize(new Dimension(200, 50));
      fillerTop.setMaximumSize(new Dimension(400, 50));
      ...
      box.setFont(Main.getHebrewFont(40F));
      boxWrapper.add(box);
