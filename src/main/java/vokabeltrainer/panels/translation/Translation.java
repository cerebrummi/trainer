...
public enum Translation
{
   ...
   ANTWORT_GEGEBEN_("Antwort gegeben."),
   ANTWORTEN_GEGEBEN_("Antworten gegeben."),
   ANTWORTFELD("Antwortfeld"),
   APPLAUS("Applaus"),
   ARTIKEL("Artikel"),
   AUCH_EINZELN_ANKLICKEN("auch einzeln anklicken."),
   AUS_DEN_AUSGEWAEHLTEN_WOERTERN("Aus den ausgewählten Wörtern."),
   ...
   BEARBEITET_("bearbeitet."),
   BEENDET_("beendet."),
   BEFEHLSFORM("Befehlsform"),
   BEKANNTE_WOERTER("bekannte Wörter"),
   ...
   BITTE_LOESCHEN_SIE_DIESEN_AUSDRUCK("Bitte löschen Sie diesen Ausdruck"),
   BITTE_SCHREIBEN_SIE_EINE_ANTWORT("Bitte schreiben Sie eine Antwort."),
   ...
   DANKE_("Danke!"),
   DAS_TRAINING_WURDE_ABGEBROCHEN_("Das Training wurde abgebrochen."),
   DATENBANK("Datenbank"),
   ...
   DIE_TRAININGSDATEN_KONTEN("Die Trainingsdaten konnten"),
   ...
   IHR_TRAININGSWORT_ENTHAELT_KEINE_BUCHSTABEN_("Ihr Trainingswort enthält keine Buchstaben."),
   IM_CSV_FORMAT_ALS_ZIP_DATEI("im csv Format als zip Datei"),
   IMPORT("Import"),
   IN_WELCHER_RICHTUNG_WOLLEN_SIE_LERNEN_("In welcher Richtung wollen Sie lernen?"),
   ...
   NICHT_GESPEICHERT_WERDEN_("nicht gespeichert werden."),
   NIF_AL("nif'al"),
   NUMERUS("Numerus"),
   ...
   SIE_HABEN("Sie haben"),
   SIE_HABEN_1NE_RICHTIGE("Sie haben 1ne richtige"),
   ...
   WIE_VIELE("Wie viele"),
   WIE_VIELE_NEUE_WOERTER_MOECHTEN_SIE_LERNEN_("Wie viele neue Wörter möchten Sie lernen?"),
   WIEDERHOLEN("wiederholen"),
   WOCHENTAG("Wochentag"),
   WOERTERBUCH("Wörterbuch"),
   WOHER_SOLLEN_DIE_VOKABELN_STAMMEN_("Woher sollen die Vokabeln stammen?"),
   ...
   WUNDERBAR__SIE_HABEN_DIESE("Wunderbar, sie haben diese"),
   WURZEL("Wurzel"),
