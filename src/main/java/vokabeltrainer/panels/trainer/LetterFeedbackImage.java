...
{
   public static BufferedImage make(HebrewLetter letterDic,
         HebrewLetter letterAnswer, boolean okay)
   {
      ...
      if (!okay)
      {
         double midX = ((double) Math.max(letterDic.getPixelWidth(),
               letterAnswer.getPixelWidth())) / 2;
         int[] xPoints = { (int) midX, 0, Math.max(letterDic.getPixelWidth(),
               letterAnswer.getPixelWidth()), ((int) midX) + 1 };
   ...
   public static BufferedImage makeNikud(LetterForAnalysis letterDic,
