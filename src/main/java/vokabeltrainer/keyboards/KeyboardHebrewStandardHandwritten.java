...
public class KeyboardHebrewStandardHandwritten extends JPanel
{
   ...
   public KeyboardHebrewStandardHandwritten(JTextComponent textfield,
   ...
   {
      DataButton jButton = new DataButton(ApplicationImages.getLetterIconsNikudHandwrittenMap()
